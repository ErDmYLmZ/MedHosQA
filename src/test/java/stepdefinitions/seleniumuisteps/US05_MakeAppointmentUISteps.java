...
public class US05_MakeAppointmentUISteps {
    ...
    @Then("user verify the phone box is not blank")
    public void userVerifyThePhoneBoxIsNotBlank() {
        Assert.assertFalse(makeAnAppointmentPage.phoneButton.getAttribute("value").isEmpty());
    }
    ...
    public void user_click_sign_in_button() {
        Driver.waitAndClick(makeAnAppointmentPage.signInButton);

    }
    @Given("user click my pages patient dropdown menu")
    public void user_click_my_pages_patient_dropdown_menu() {
        Driver.waitAndClick(makeAnAppointmentPage.myPagesPatientDropDownMenu);

    }
    @Given("user click my appointments")
    public void user_click_my_appointments() {
        Driver.waitAndClick(makeAnAppointmentPage.myAppointmentsDropDown);

    }
    @Then("Verify user appointments pages")
    public void verify_user_appointments_pages() {
        Driver.waitAndClick(makeAnAppointmentPage.appointmentsDisplayed);

    }
    @And("user enters sign in password")
    public void userEntersSignInPassword() {
        Driver.waitAndSendText(makeAnAppointmentPage.passwordSignInButton ,"123Alis.");
    }
